...
int main() {
    ...
    cin >> m;
    cout << "Najmniejszy wspolny dzielnik liczb " << n << " i " << m << " wynosi: " << nww(n, m) << endl;
    return 0;
}
// Wyjaśnienie:
...
// Wyświetlamy najmniejszy wspólny dzielnik liczb n i m za pomocą funkcji nww(n, m) i cout.